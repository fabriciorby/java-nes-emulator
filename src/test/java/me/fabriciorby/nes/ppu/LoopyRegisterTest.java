...
class LoopyRegisterTest {
    ...
    void set() {
        ...
        assertEquals(loopyRegister.get(LoopyRegister.Loopy.COARSE_X), 0b01100);
        ...
        assertEquals(loopyRegister.get(LoopyRegister.Loopy.COARSE_X), 0b11111);
        ...
        loopyRegister.set(LoopyRegister.Loopy.COARSE_Y, loopyRegister.get(LoopyRegister.Loopy.COARSE_Y) + 1);
        assertEquals(loopyRegister.get(LoopyRegister.Loopy.COARSE_X), 0b11111);
        assertEquals(loopyRegister.get(LoopyRegister.Loopy.COARSE_Y), 0b00000);
        printLoopy();

        loopyRegister.set(LoopyRegister.Loopy.COARSE_X, loopyRegister.get(LoopyRegister.Loopy.COARSE_X) + 1);
        assertEquals(loopyRegister.get(LoopyRegister.Loopy.COARSE_X), 0b00000);
        assertEquals(loopyRegister.get(LoopyRegister.Loopy.COARSE_Y), 0b00000);
        printLoopy();
    }
